    ...
    <div className="splash">
      ...
      <section className="about">
        <div className="about-header">
          <h3 className="heading-secondary">True style never dies</h3>
        </div>
        <div className="row">
          <div className="col-1-of-2">
            ...
            <p className="paragraph">
              ...
              earum suscipit assumenda. Possimus atque labore nesciunt voluptas,
              vero doloribus officia exercitationem necessitatibus, mollitia,
              facere eius! Aliquid deserunt vel doloribus.
            </p>
            <h3 className="heading-tertiary u-margin-bottom-small">
          ...
          <div className="col-1-of-2">
            <div className="composition">
              <img
                className="street-photo p1"
                alt="Street Photo 1"
                src={Street1}
              ></img>
              <img
                className="street-photo p2"
                alt="Street Photo 2"
                src={Street2}
              ></img>
              <img
                className="street-photo p3"
                alt="Street Photo 3"
                src={Street3}
              ></img>
            </div>
          ...
          <div className="col-1-of-4">
            <div className="feature-box">
              ...
              <p className="feature-box-text">
                ...
                suscipit fugit ab doloribus nulla repudiandae iusto dolores
                officia.
              </p>
            </div>
          </div>
